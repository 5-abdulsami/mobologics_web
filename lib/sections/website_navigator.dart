...
import 'package:mobologics_web/sections/home_section.dart';
import 'package:mobologics_web/sections/services_section.dart';
import 'package:mobologics_web/sections/contact_us_section.dart';
...
class _WebsiteNavigatorState extends State<WebsiteNavigator> {
  ...
  List<Widget> _buildMenuItems({required bool isDesktop}) {
    return [
      ...
      _menuItem("Contact Us", 2, isDesktop),
    ];
  }
